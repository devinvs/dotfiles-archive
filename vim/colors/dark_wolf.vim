...
" Default colors
set background=dark
let s:caret = { 'gui': '#ffbf47', 'cterm': 220 }
let s:white = { 'gui': '#ffffff', 'cterm': 231 }
let s:black = { 'gui': '#000000', 'cterm': 232 }
let s:red = { 'gui': '#f3636c', 'cterm': 203 }
let s:orange = { 'gui': '#f38f63', 'cterm': 209 }
let s:yellow = { 'gui': '#ffbf47', 'cterm': 11 }
let s:green = { 'gui': '#5fc883', 'cterm': 2 } " 186 –– almost perfect match
let s:cyan = { 'gui': '#6ad0ea', 'cterm': 117 }
let s:blue = { 'gui': '#598fd8', 'cterm': 111 }
let s:paleblue = { 'gui': '#6682a8', 'cterm': 152 }
let s:purple = { 'gui': '#c38cd5', 'cterm': 176 }
let s:brown = { 'gui': '#ae6647', 'cterm': 137 }
let s:pink = { 'gui': '#d56fc4', 'cterm': 204 }
let s:violet = { 'gui': '#956ba2', 'cterm': 139 }

let s:bg = { 'gui': '#020e16', 'cterm': 'none' }
...
let s:line_numbers = { 'gui': '#cecece', 'cterm': 0 }
